const translations = {
  ru: {
    ...
    header_price: "ЦЕНА",
    header_stock: "ОСТ",
    total_label_sale: "ИТОГО:",
    total_label_return: "К ВОЗВРАТУ:",
    pay_cash: "Нал",
    pay_qr: "QR",
    pay_red: "Red",
    pay_card: "Карт",
    ...
    btn_close: "ЗАКРЫТЬ",
    btn_close_report: "ЗАКРЫТЬ ОТЧЕТ",
    settings_title: "НАСТРОЙКИ",
    settings_lang: "ЯЗЫК ИНТЕРФЕЙСА",
    settings_sync: "СИНХРОНИЗАЦИЯ",
    settings_system: "СИСТЕМА",
    btn_sync: "Отправить чеки",
    btn_update: "Обновить кэш",
    btn_base: "База",
    msg_sync_empty: "Все чеки уже отправлены!",
    msg_sync_success: "Синхронизация успешна!",
    msg_sync_error: "Ошибка сети.",
    txt_sale_confirm: "ПОДТВЕРДИТЬ ПРОДАЖУ",
    txt_return_confirm: "ПОДТВЕРДИТЬ ВОЗВРАТ",
    txt_payment: "Оплата: ",
    txt_total: "ИТОГО: ",
    ...
    btn_gallery: "ГАЛЕРЕЯ",
    btn_saved: "СОХРАНЕНО!",
    report_name: "НАИМЕНОВАНИЕ",
    report_qty: "КОЛ.",
    report_sum: "СУММА",
    report_in_register: "В КАССЕ:",
    msg_loading: "ЗАГРУЗКА...",
    msg_no_internet: "НЕТ ИНТЕРНЕТА",
    msg_no_data: "ОПЕРАЦИЙ НЕ НАЙДЕНО",
    msg_server_error: "ОШИБКА СЕРВЕРА",
    report_avg: "ср:",
    ...
    receive_btn: "ПРИЕМКА",
    pin_no_internet: "НЕТ ИНТЕРНЕТА",
    pin_checking: "ПРОВЕРКА...",
    pin_granted: "ДОСТУП РАЗРЕШЕН",
    pin_wrong_left: "НЕВЕРНЫЙ ПИН. ОСТАЛОСЬ: ",
    pin_conn_error: "СБОЙ ПОДКЛЮЧЕНИЯ",
    inc_err_no_doc: "нет номера инвойса",
    inc_err_no_sup: "нет поставщика",
    inc_err_no_table: "таблица с товарами не найдена",
    inc_err_missing: "в шапке (строка {0}) не найдено: ",
    inc_err_no_items: "из таблицы не удалось извлечь товары",
    inc_success: "{0} поз. распознано",
    inc_err_doc_format: "ОШИБКА НОМЕРА",
    inc_lbl_sup: "Поставщик:",
    inc_lbl_doc: "Документ:",
    inc_lbl_items: "Позиций:",
    inc_sending: "Отправка {0}...",
    inc_server_err: "Ошибка сервера",
    inc_send_err: "❌ Ошибка при отправке инвойса: ",
    inc_archive_created: "Архив создан! Склад обновлен.",
    word_code: "«Код»",
    word_qty: "«Кол-во»",
    word_price: "«Цена»",
    login_title: "ВХОД",
    inc_err_sheet_missing: "[Лист {0}] стр. {1}: нет ",
    inc_err_sheet_no_table: "[Лист {0}]: нет таблицы с цифрами",
    cat_all: "Все",
    server_dup: "Накладная с номером {0} уже была проведена ранее.",
    server_no_db: "База не привязана. Нажмите POS Setup -> Привязать базу.",
    theme_toggle: "Смена Темы (ДЕНЬ/НОЧЬ)",
    ...
    inc_all_done:
      "✅ Все накладные успешно проведены, оригиналы сохранены в папки!",
    ...
    photo_err:
      "⚠️ ФОТО НЕДОСТУПНО<br><br>Google отклонил запрос или файл удален",
    ...
    server_dup_fp:
      "Файл с точно таким же составом товаров уже был загружен ранее! Проверьте базу.",
    ...
    report_sales: "ПРОДАЖИ",
    report_returns: "ВОЗВРАТЫ",
    report_total_net: "Итого (чис.):",
    report_items: "ТОВАРЫ",
    report_receipts: "ЧЕКИ",
    settings_help: "Справка",
    btn_help: "Руководство пользователя",
    qe_title: "РАСПРЕДЕЛЕНИЕ ТОВАРА",
    qe_name: "Наименование",
    qe_name_hint:
      "* Если не появляется экранная клавиатура, нажмите 2 раза кнопку на сканере",
    ...
    auth_desc:
      "Для получения доступа к кассовому терминалу и синхронизации с базой данных, пожалуйста, войдите под своим рабочим Google-аккаунтом.",
    btn_google: "ВОЙТИ ЧЕРЕЗ GOOGLE",
    setup_network_error_title: "Нет связи с Google Диском",
    setup_network_error_desc:
      "Системе не удалось создать файлы базы данных. Запрос был заблокирован или прерван.",
    setup_network_error_step1: "Интернет: проверьте соединение (Wi-Fi/LTE).",
    setup_network_error_step2:
      "Блокировщики: если включен AdGuard или антивирус, временно приостановите его работу.",
    setup_network_error_step3:
      "Браузер: если ссылка открыта в Telegram или WhatsApp, перейдите в Safari или Chrome.",
    setup_btn_retry: "Повторить попытку",
    setup_license_error_title: "Установка отклонена",
    setup_license_error_desc:
      "Касса уже была установлена на данный Google аккаунт.",
    setup_license_error_step1:
      "Для новой установки (тестового периода) используйте другой аккаунт Google.",
    setup_license_error_step2:
      "Для продления текущей кассы обратитесь к администратору.",
    ...
    swal_clear_text:
      "Выберите тип очистки. Текущие данные будут временно сохранены в архив.",
    ...
    swal_catalog_warn_text:
      "Старые чеки будут навсегда удалены из быстрого буфера. Вы уверены?",
    swal_catalog_warn_confirm:
      "Да, восстановить только каталог<br>(Накладные и Товары)",
    swal_restore_title: "ВОССТАНОВЛЕНИЕ ДАННЫХ",
    swal_restore_text:
      "Выберите, какие данные нужно вернуть из временного архива.",
    ...
    mapper_err_dup:
      "Ошибка: Вы назначили одну и ту же роль сразу нескольким колонкам!",
    mapper_err_missing:
      "Ошибка: Обязательно укажите колонки «Кол-во» и «Цена»!",
    ...
    error_parse_template:
      "Ошибка: Не удалось распознать структуру шаблона Kaspi.",
    ...
    help_modal_internal_desc:
      "Товар не пойдет на маркетплейс. Отличный вариант для обычных продаж.",
    help_modal_kaspi_title: "🛒 БАЗА + KASPI (Умный импорт):",
    help_modal_kaspi_desc:
      "Умная приёмка. Потребуется указать Бренд, Размеры и другие обязательные атрибуты.",
    ...
    mapper_err_missing_cols:
      "⚠️ Обязательно привяжите колонки:\n1. Наименование (или model)\n2. Количество (qty)\n3. Цена (price)",
    btn_base: "База",
    // НОВЫЕ КЛЮЧИ:
    msg_analyze_template: "Анализ шаблона...",
    msg_save_server: "Сохранение на сервер...",
  ...
  kz: {
    ...
    header_price: "БАҒА",
    header_stock: "ҚАЛД",
    total_label_sale: "БАРЛЫҒЫ:",
    total_label_return: "ҚАЙТАРЫЛАТЫН:",
    pay_cash: "Қолма",
    pay_qr: "QR",
    pay_red: "Red",
    pay_card: "Карта",
    ...
    btn_confirm: "РАСТАУ",
    btn_close: "ЖАБУ",
    btn_close_report: "ЕСЕПТІ ЖАБУ",
    settings_title: "ПАРАМЕТРЛЕР",
    settings_lang: "ИНТЕРФЕЙС ТІЛІ",
    settings_sync: "СИНХРОНДАУ",
    settings_system: "ЖҮЙЕ",
    btn_sync: "Чектерді жіберу",
    btn_update: "Кэшті жаңарту",
    btn_base: "База",
    msg_sync_empty: "Чектер жоқ!",
    msg_sync_success: "Сәтті аяқталды!",
    msg_sync_error: "Желі қатесі.",
    txt_sale_confirm: "САТУДЫ РАСТАУ",
    txt_return_confirm: "ҚАЙТАРУДЫ РАСТАУ",
    txt_payment: "Төлем: ",
    txt_total: "БАРЛЫҒЫ: ",
    btn_add_cart: "СЕБЕТКЕ САЛУ",
    btn_save_db: "БАЗАҒА САҚТАУ",
    btn_camera: "КАМЕРА",
    btn_gallery: "ГАЛЕРЕЯ",
    btn_saved: "САҚТАЛДЫ!",
    report_name: "АТАУЫ",
    report_qty: "САНЫ",
    report_sum: "СОМАСЫ",
    report_in_register: "КАССАДА:",
    msg_loading: "ЖҮКТЕЛУДЕ...",
    msg_no_internet: "ИНТЕРНЕТ ЖОҚ",
    msg_no_data: "ОПЕРАЦИЯЛАР ЖОҚ",
    msg_server_error: "СЕРВЕР ҚАТЕСІ",
    report_avg: "орт:",
    ...
    pin_no_internet: "ИНТЕРНЕТ ЖОҚ",
    pin_checking: "БАЗАДАН ТЕКСЕРІЛУДЕ...",
    pin_granted: "РУҚСАТ БЕРІЛДІ",
    pin_wrong_left: "ҚАТЕ ПИН. ҚАЛДЫ: ",
    pin_conn_error: "ҚОСЫЛУ ҚАТЕСІ",
    inc_err_no_doc: "инвойс нөмірі жоқ",
    inc_err_no_sup: "жеткізуші жоқ",
    inc_err_no_table: "тауарлар кестесі табылмады",
    inc_err_missing: "бас жағында ({0}-жол) табылмады: ",
    inc_err_no_items: "кестеден тауарларды оқу мүмкін болмады",
    inc_success: "{0} поз. анықталды",
    inc_err_doc_format: "НӨМІР ҚАТЕСІ",
    inc_lbl_sup: "Жеткізуші:",
    inc_lbl_doc: "Құжат:",
    inc_lbl_items: "Позициялар:",
    inc_sending: "{0} жіберілуде...",
    inc_server_err: "Сервер қатесі",
    inc_send_err: "❌ Инвойсты жіберу қатесі: ",
    inc_archive_created: "Мұрағат құрылды! Қойма жаңартылды.",
    word_code: "«Код»",
    word_qty: "«Саны»",
    word_price: "«Бағасы»",
    login_title: "КІРУ",
    inc_err_sheet_missing: "[{0} парағы] {1}-жол: табылмады ",
    inc_err_sheet_no_table: "[{0} парағы]: цифрлары бар кесте жоқ",
    cat_all: "Барлығы",
    server_dup: "{0} нөмірлі жүкқұжат бұрын қабылданған.",
    server_no_db:
      "Дерекқор байланыспаған. POS Setup -> Привязать базу түймесін басыңыз.",
    theme_toggle: "Тақырыпты ауыстыру (КҮН/ТҮН)",
    settings_theme: "КӨРІНІС",
    ...
    inc_all_done:
      "✅ Барлық жүкқұжаттар сәтті өтті, түпнұсқалар папкаларға сақталды!",
    ...
    photo_err:
      "⚠️ ФОТО ҚОЛЖЕТІМСІЗ<br><br>Google сұрауды қабылдамады немесе файл жойылды",
    ...
    server_dup_fp:
      "Құрамы дәл осындай файл бұрын жүктелген! Базаны тексеріңіз.",
    ...
    setup_footer:
      "Жүйе сіздің Google Drive-та папкалар құрылымын автоматты түрде жасайды.",
    ...
    report_sales: "САТЫЛЫМДАР",
    report_returns: "ҚАЙТАРЫМДАР",
    report_total_net: "Таза табыс:",
    report_items: "ТАУАРЛАР",
    report_receipts: "ЧЕКТЕР",
    settings_help: "Анықтама",
    btn_help: "Пайдаланушы нұсқаулығы",
    qe_title: "ТАУАРДЫ БӨЛУ",
    qe_name: "Атауы",
    qe_name_hint:
      "* Экрандық пернетақта көрінбесе, сканердегі батырманы 2 рет басыңыз",
    qe_category: "Санат",
    ...
    auth_title: "Авторизация",
    auth_desc:
      "Кассалық терминалға қол жеткізу және деректер қорымен синхрондау үшін жұмыс Google-аккаунтыңызбен кіріңіз.",
    btn_google: "GOOGLE АРҚЫЛЫ КІРУ",
    setup_network_error_title: "Google Дискпен байланыс жоқ",
    setup_network_error_desc:
      "Жүйе деректер қоры файлдарын жасай алмады. Сұраным бұғатталды немесе үзілді.",
    setup_network_error_step1: "Интернет: қосылымды тексеріңіз (Wi-Fi/LTE).",
    setup_network_error_step2:
      "Бұғаттаушылар: AdGuard немесе антивирус қосулы болса, оны уақытша тоқтата тұрыңыз.",
    setup_network_error_step3:
      "Браузер: сілтеме Telegram немесе WhatsApp ішінде ашылса, Safari немесе Chrome-ға өтіңіз.",
    ...
    setup_license_error_step1:
      "Жаңадан орнату үшін (сынақ мерзімі) басқа Google аккаунтын пайдаланыңыз.",
    setup_license_error_step2:
      "Қазіргі кассаны ұзарту үшін әкімшіге хабарласыңыз.",
    ...
    swal_clear_text:
      "Тазалау түрін таңдаңыз. Ағымдағы деректер уақытша мұрағатта сақталады.",
    ...
    swal_catalog_warn_text:
      "Ескі чектер жылдам буферден біржолата жойылады. Сенімдісіз бе?",
    swal_catalog_warn_confirm:
      "ИӘ, КАТАЛОГТЫ ҒАНА ҚАЛПЫНА КЕЛТІРУ<br>(Жүкқұжаттар, Тауарлар)",
    swal_restore_title: "ДЕРЕКТЕРДІ ҚАЛПЫНА КЕЛТІРУ",
    swal_restore_text:
      "Уақытша мұрағаттан қандай деректерді қайтару керектігін таңдаңыз.",
    swal_restore_catalog_btn: "ТЕК КАТАЛОГ (Тауарлар мен Жүкқұжаттар)",
    swal_restore_all_btn:
      "БАРЛЫҒЫН ҚАЛПЫНА КЕЛТІРУ<br>(Чектер, Жүкқұжаттар, Тауарлар)",
    ...
    mapper_err_missing:
      "Қате: «Саны» және «Бағасы» бағандарын міндетті түрде көрсетіңіз!",
    ...
    error_parse_template:
      "Қате: Kaspi шаблонының құрылымын анықтау мүмкін болмады.",
    ...
    help_modal_internal_desc:
      "Тауар маркетплейске шығарылмайды. Қарапайым сатылымдар үшін оңтайлы нұсқа.",
    help_modal_kaspi_title: "🛒 БАЗА + KASPI (Ақылды импорт):",
    help_modal_kaspi_desc:
      "Ақылды қабылдау. Бренд, Өлшемдер және басқа да міндетті атрибуттарды көрсету талап етіледі.",
    ...
    mapper_err_missing_cols:
      "⚠️ Бағандарды міндетті түрде байланыстырыңыз:\n1. Атауы (немесе model)\n2. Саны (qty)\n3. Бағасы (price)",
    btn_base: "Дерекқор",
    // ЖАҢА КІЛТТЕР:
    msg_analyze_template: "Шаблонды талдау...",
    msg_save_server: "Серверге сақтау...",
...
window.showLoading = function (text, i18nKey = null) {
  ...
  if (!loader) {
    ...
    loader.style.cssText =
      "display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.85); z-index: 999999; justify-content: center; align-items: center; flex-direction: column; color: #2ecc71; font-family: sans-serif;";
    loader.innerHTML = `
...
const originalApplyLanguage =
  typeof applyLanguage === "function" ? applyLanguage : null;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (invInput) {
    invInput.addEventListener("change", function (e) {
      ...
      if (file && labelSpan) {
        try {
          if (labelSpan.previousElementSibling)
...
window.smartFetch = async function (url, payload, cacheKey, maxRetries = 3) {
  ...
  for (let i = 0; i < maxRetries; i++) {
    ...
    try {
      ...
      console.warn(
        `Попытка ${i + 1} из ${maxRetries} для ${payload.action} не удалась:`,
        isTimeout ? "Превышено время ожидания сервера" : error.message,
      );
...
setInterval(() => {
  ...
  if (queue.length > 0 && navigator.onLine && !window.isSyncing) {
    console.log(
      "🕒 Сработал запасной таймер: отправляем накопившиеся данные...",
    );
    window.syncOfflineQueue();
  }
}, 10000);
...
window.suppliersList = JSON.parse(
  localStorage.getItem("suppliers_cache") || "[]",
);
...
window.setQeActive = function (el, event) {
  ...
  const isReceiveMode =
    receiveBlock && window.getComputedStyle(receiveBlock).display !== "none";
...
window.qeNumpad = function (val, event) {
  ...
  if (currentVal === "") {
    ...
    window.currentQeInput.value = Number(currentVal)
...
window.renderSupplierList = function () {
  ...
  const newBtnText =
    translations[currentLang].qe_supplier_new || "+ Новый поставщик";
...
window.openQuickEditModal = function (id) {
  ...
  const lang =
    savedLang ||
    window.currentLang ||
    (typeof currentLang !== "undefined" ? currentLang : "ru");

  // Получаем словарь (используем 'kz' или 'ru')
  const dict =
    typeof translations !== "undefined" && translations[lang]
      ? translations[lang]
      : typeof translations !== "undefined" && translations["ru"]
        ? translations["ru"]
        : {};
  ...
  let currentCatText =
    !item.category || item.category === "0"
      ...
      : item.category;
  let currentCatValue =
    !item.category || item.category === "0" ? "0" : item.category;
  ...
  const supplierList =
    Array.isArray(window.suppliers) && window.suppliers.length > 0
      ? window.suppliers
      : [];
  ...
  try {
    ...
    if (mainSupplierInput) {
      mainSupplierInput.placeholder =
        translations[currentLang].modal_choose_supplier;
    }
  } catch (e) {}
  ...
  canvas.toBlob(async (blob) => {
    ...
    try {
      ...
      if (code) {
        ...
        alert(
          "Штрихкод на снимке не распознан. Поправьте фокус и нажмите еще раз.",
        );
      }
    } catch (err) {
...
window.saveQuickEdit = function (id) {
  ...
  receiveBlocks.forEach((b) => {
    if (b.offsetParent !== null) isReceiveMode = true;
  });
  ...
  if (isReceiveMode) {
    ...
    let supplier =
      ...
      translations[currentLang].modal_unknown_supplier
        ? translations[currentLang].modal_unknown_supplier
    ...
    const requestFingerprint =
      "income_" + Date.now() + "_" + Math.floor(Math.random() * 1000);
      ...
      data: [
        {
          ...
          category:
            !item.category ||
            String(item.category).trim() === "0" ||
            String(item.category).trim().toLowerCase() === "не выбрано"
              ? "Без категории"
              : item.category,
          // ===============================================
          cbm: 0,
    ...
    if (newName === "" && item.name !== "" && item.name !== "Без названия") {
      alert(
        "Сработала защита: скрипт попытался сохранить пустое имя. Попробуйте еще раз.",
      );
      return;
    }

    const newPrice =
      parseFloat(String(rawPrice).replace(/\s/g, "").replace(",", ".")) || 0;
    const newMinStock =
      parseFloat(String(rawMinStock).replace(/\s/g, "").replace(",", ".")) || 0;
    ...
    if (
      !newCategory ||
      newCategory === "0" ||
      newCategory.toLowerCase() === "не выбрано"
    ) {
  ...
  document.querySelectorAll("#quickEditModal").forEach((m) => m.remove());
  document
    .querySelectorAll("[data-tippy-root], .tippy-box, .dropdown-menu")
    .forEach((t) => t.remove());
...
window.saveNewProduct = function () {
  ...
  // Берем поставщика
  const supplier =
    document.getElementById("nt-supplier-input").value.trim() || "Не указан";
  ...
  if (
    !category ||
    category === "0" ||
    category.toLowerCase() === "не выбрано"
  ) {
  ...
  const qty =
    parseInt(document.getElementById("nt-qty").value.replace(/\D/g, ""), 10) ||
    0;
  const priceIn =
    parseInt(
      document.getElementById("nt-price-in").value.replace(/\D/g, ""),
      10,
    ) || 0;
  const priceOut =
    parseInt(
      document.getElementById("nt-price-out").value.replace(/\D/g, ""),
      10,
    ) || 0;
  ...
  const requestFingerprint =
    "new_item_" + Date.now() + "_" + Math.floor(Math.random() * 1000);
  ...
  if (blockUntil > Date.now()) {
    ...
    const interval = setInterval(() => {
      ...
      if (remaining <= 0) {
        ...
        err.innerText =
          translations[currentLang].pin_block +
          `${mins}:${secs < 10 ? "0" : ""}${secs}`;
      }
    }, 1000);
    return true;
...
function sm(m) {
  ...
  document.getElementById("tl").innerText =
    m === "return"
      ? translations[currentLang].total_label_return
      : translations[currentLang].total_label_sale;
...
async function handleAutoLogin(val) {
  ...
  if (!navigator.onLine) {
    ...
    if (savedPin && savedUser && securedPin === savedPin) {
      ...
      err.innerText =
        translations[currentLang].pin_granted +
        translations[currentLang].status_offline;
      ...
      err.innerText = savedPin
        ? translations[currentLang].pin_wrong
        : translations[currentLang].pin_no_internet;
      err.style.color = "var(--accent-red)";
      err.style.visibility = "visible";
      setTimeout(() => {
  ...
  try {
    ...
    if (res.success) {
      ...
      if (
        res.error &&
        (res.error.includes("api_key") ||
          res.error.includes("База клиента не найдена") ||
    ...
    if (error.message === "BAD_API_KEY") {
      localStorage.clear();
      alert(
        "Ключ доступа устарел. Приложение будет перезагружено для безопасности.",
      );
    ...
    err.innerText = isWrongPin
      ? `${translations[currentLang].pin_wrong_left}${attemptsLeft}`
      : translations[currentLang].pin_conn_error;
    err.style.color = "var(--accent-red)";
    err.style.visibility = "visible";
...
async function load(isFullSync = false) {
  ...
  try {
    ...
    if (cachedTotals) {
      ...
      document.getElementById("sum-cash").innerText =
        (t.cash || 0).toLocaleString() + " ₸";
      document.getElementById("sum-qr").innerText =
        (t.qr_kaspi || t.qr || 0).toLocaleString() + " ₸";
      document.getElementById("sum-red").innerText =
        (t.installment || 0).toLocaleString() + " ₸";
      document.getElementById("sum-card").innerText =
        (t.pos_terminal || t.card || 0).toLocaleString() + " ₸";
      document.getElementById("sum-trans").innerText =
        (t.transfer || 0).toLocaleString() + " ₸";
    }
  ...
  if (!isFullSync && localStorage.getItem("db_cache")) {
    try {
      ...
      console.warn(
        "⚠️ Ошибка пинга (возможно, сервер занят):",
        pingErr.message,
      );
    }
  }
  ...
  for (let i = 0; i < 3; i++) {
    try {
      ...
      console.warn(
        `Попытка ${i + 1} из 3 для загрузки базы не удалась:`,
        err.message,
      );
  ...
  try {
    if (data.items) {
      if (isFullSync || localTimestamp === "0" || !db || db.length === 0) {
        ...
        if (updatedCount > 0) {
          ...
          console.log(
            `🔄 Дельта-синхронизация: обновлено ${updatedCount} товаров.`,
          );
        } else {
    ...
    document.getElementById("sum-qr").innerText =
      (t.qr_kaspi || t.qr || 0).toLocaleString() + " ₸";
    document.getElementById("sum-red").innerText =
      (t.installment || t.red || 0).toLocaleString() + " ₸";
    document.getElementById("sum-card").innerText =
      (t.pos_terminal || t.pos || t.card || 0).toLocaleString() + " ₸";
    document.getElementById("sum-trans").innerText =
      (t.transfer || 0).toLocaleString() + " ₸";
...
async function refreshPosData(isSilent = false, isFullSync = false) {
  ...
  try {
    ...
    if (!isSilent && btn) {
      setTimeout(() => {
        btn.classList.remove("sync-spin");
      }, 600);
    }
  }
}
...
function render() {
  ...
  if (!db || db.length === 0)
    return (catalog.innerHTML =
      ...
      translations[currentLang].loading_items +
      "</div>");
  catalog.innerHTML = db
    .map((i) => {
...
function handleSearchInput() {
  document.getElementById("clear-search").style.display =
    document.getElementById("sb").value.length > 0 ? "flex" : "none";
  filter();
}
...
function add(id) {
  ...
  const clickedElement =
    typeof event !== "undefined" && event
      ? event.currentTarget || event.target.closest(".c-item")
      : null;
    ...
    if (i.qty <= 0) {
      ...
      if (row) {
        ...
        row.style.background =
          d > 0 ? "var(--bg-success-dim)" : "var(--bg-danger-dim)";
...
function initPay(methodCode, methodName) {
  ...
  btnConfirm.style.color =
    methodCode === "transfer" ? "var(--text-dark)" : "#fff";
  document.getElementById("r-title").innerText =
    mode === "sale"
      ? translations[currentLang].txt_sale_confirm
      : translations[currentLang].txt_return_confirm;
  document.getElementById("r-method").innerText =
    translations[currentLang].txt_payment + methodName;
  document.getElementById("r-items-list").innerHTML = cart
    .map(
      (c) =>
        `<div class="r-item"><span>${c.name}</span><b>${c.qty} x ${c.price.toLocaleString()}</b></div>`,
    )
    .join("");
  document.getElementById("r-total").innerText =
    translations[currentLang].txt_total +
    cart.reduce((a, b) => a + b.price * b.qty, 0).toLocaleString() +
    " ₸";
...
async function confirmTx() {
  ...
  const appSource =
    typeof APP_VERSION !== "undefined" ? "pos_v" + APP_VERSION : "pos_v5.5.0";
  ...
  try {
    ...
    if (targetId) {
      ...
      if (el) {
        ...
        currentSum =
          mode === "sale" ? currentSum + cartTotal : currentSum - cartTotal;
...
function moveTxToCacheLocally(tx) {
  try {
    ...
    console.error("Ошибка переливания кэша", e);
  }
}
...
function openReport() {
  ...
  if (role === "manager") {
    ...
    titleEl.innerText =
      currentLang === "kz" ? "КЕЗЕҢДІК ЕСЕП" : "ОТЧЕТ ЗА ПЕРИОД";
  } else {
    if (controls) controls.style.display = "none";
    titleEl.innerText =
      (currentLang === "kz" ? "БҮГІНГІ ЕСЕП: " : "ОТЧЕТ ЗА СЕГОДНЯ: ") +
...
async function renderReport() {
  ...
  const uiStr = {
    sale: translations[currentLang].report_sales,
    ret: translations[currentLang].report_returns,
    avg: translations[currentLang].report_avg || "ср:",
  };
  // ОТСЕКАЕМ РЕЗЕРВЫ (Они еще не стали деньгами и не должны идти в отчет)
  reportDataToRender = reportDataToRender.filter(
    (tx) => tx.type !== "reserve" && tx.type !== "unreserve",
  );
  ...
  document.getElementById("rep-sum-all").innerText =
    totalAllNet.toLocaleString() + " ₸";
  document.getElementById("rep-sum-cash").innerText =
    (cardSums.cash || 0).toLocaleString() + " ₸";
  document.getElementById("rep-sum-qr").innerText =
    (cardSums.qr_kaspi || 0).toLocaleString() + " ₸";
  document.getElementById("rep-sum-card").innerText =
    (cardSums.pos_terminal || 0).toLocaleString() + " ₸";
  document.getElementById("rep-sum-red").innerText =
    (cardSums.installment || 0).toLocaleString() + " ₸";
  document.getElementById("rep-sum-trans").innerText =
    (cardSums.transfer || 0).toLocaleString() + " ₸";

  // Обновляем новую карточку
  const marketCardSum = document.getElementById("rep-sum-market");
  if (marketCardSum)
    marketCardSum.innerText = (cardSums.market || 0).toLocaleString() + " ₸";
  ...
  if (reportState.method !== "all") {
    viewTx = viewTx.filter((tx) => {
      let grp = (tx.methodCode || "cash").includes("market")
        ? "market"
        : tx.methodCode || "cash";
  ...
  if (reportState.view === "items") {
    ...
    viewTx.forEach((tx) => {
      let mGroup = (tx.methodCode || "cash").includes("market")
        ? "market"
        : tx.methodCode || "cash";
      tx.cart.forEach((c) => {
        ...
        if (!agg[key].sellers[tx.seller])
          agg[key].sellers[tx.seller] = { qty: 0, sum: 0 };
    ...
    sorted.forEach((item) => {
      ...
      let methodTag =
        reportState.method === "all"
          ? ` <span class="acc-method-tag" style="color:${mColor}; font-size:10px;">[${methodNames[item.method]}]</span>`
          : "";
      ...
      if (
        item.method === "market" &&
        (item.totalCom > 0 || item.totalLog > 0)
      ) {
        let strCom =
          translations[currentLang].report_market_commission ||
          "Комиссия маркета";
        let strLog =
          translations[currentLang].report_market_logistics || "Логистика";
        let strNet = translations[currentLang].report_market_net || "К выплате";

        // Авто-перевод без добавления в словарь
        let strGross =
          currentLang === "kz" ? "Бастапқы сома" : "Исходная сумма";
        ...
        if (item.totalCom > 0)
          detHtml += `<div class="acc-detail-row" style="color: var(--accent-red); font-size: 11px;"><span>↳ ${strCom}</span><span>-${item.totalCom.toLocaleString()}</span></div>`;
        if (item.totalLog > 0)
          detHtml += `<div class="acc-detail-row" style="color: var(--accent-red); font-size: 11px;"><span>↳ ${strLog}</span><span>-${item.totalLog.toLocaleString()}</span></div>`;
    ...
    viewTx.forEach((tx) => {
      ...
      let methodTag =
        reportState.method === "all"
          ? ` <span style="color:${mColor}; font-size:10px;">[${methodNames[mGroup]}]</span>`
          : "";
      ...
      if (mGroup === "market") {
        ...
        if (tCom > 0)
          detHtml += `<div class="acc-detail-row" style="color: var(--accent-red); font-size: 11px;"><span>↳ ${strCom}</span><span>-${tCom.toLocaleString()}</span></div>`;
        if (tLog > 0)
          detHtml += `<div class="acc-detail-row" style="color: var(--accent-red); font-size: 11px;"><span>↳ ${strLog}</span><span>-${tLog.toLocaleString()}</span></div>`;
...
function setReportMethod(method, element, activeClass) {
  ...
  document
    ...
    .forEach((c) => (c.className = "method-card"));
...
function setReportType(type) {
  ...
  document
    .getElementById("t-return")
    .classList.toggle("active", type === "return");
  renderReport();
}
...
function setReportView(view) {
  ...
  document
    .getElementById("t-item")
    .classList.toggle("active", view === "items");
  document
    .getElementById("t-date")
    .classList.toggle("active", view === "dates");
  renderReport();
}
...
function openItemMenu(id) {
  ...
  document.getElementById("btn-cancel-modal").innerText =
...
function handleCancelModal() {
  ...
  else document.getElementById("item-menu-modal").style.display = "none";
}
function confirmAddFromMenu() {
  add(selectedItemId);
  document.getElementById("item-menu-modal").style.display = "none";
}
  ...
  reader.onload = function (e) {
    ...
    img.onload = function () {
      ...
      document.getElementById("photo-preview").innerHTML =
        `<img src="${tempBase64}" onclick="openFullscreen('${tempBase64}')" style="max-width: 100%; max-height: 250px; border-radius: 8px; border: 1px solid var(--border-focus); margin-top: 10px; cursor: zoom-in;">`;
...
async function confirmUpload() {
  ...
  try {
    ...
    if (responseData.success) {
      ...
      btnSaveDb.innerHTML =
        '💾 <span data-i18n="btn_save_db">' +
        translations[currentLang].btn_save_db +
        "</span>";
...
document.addEventListener("keypress", function (e) {
  ...
  if (e.key === "Enter") {
    if (barcodeBuffer.length > 2) {
      e.preventDefault();
      const item = db.find((i) => String(i.barcode) === String(barcodeBuffer));
      if (item) {
        add(item.id);
  ...
  if (!response || !response.success) {
    throw new Error(
      response
        ...
        : "Сервер не ответил при сохранении шаблона",
    );
  }
  ...
  for (let i = 0; i < humanNames.length; i++) {
    ...
    const reqText =
      requirements && requirements[i]
        ? String(requirements[i]).toLowerCase()
        : "";
    const isRequired =
      reqText.includes("обязательн") && !reqText.includes("необязательн");
    const reqAsterisk = isRequired
    ...
    if (allUniqueValues.length > 0) {
      ...
      if (allUniqueValues.length <= 50) {
        optionsHtml += allUniqueValues
          .map((val) => `<option value="static_${val}">📌 ${val}</option>`)
          .join("");
      } else {
    ...
    // 1. Жесткие правила
    if (sys === "merchant_sku" || hum.includes("артикул"))
      autoSelectValue = "barcode";
    else if (sys === "name" || hum.includes("название"))
      autoSelectValue = "name";
    else if (sys === "price" || hum.includes("цена")) autoSelectValue = "price";
    else if (sys === "brand" || hum.includes("бренд"))
      autoSelectValue = "json_Бренд";
    ...
    if (autoSelectValue) {
      finalOptionsHtml = finalOptionsHtml.replace(
        `value="${autoSelectValue}"`,
        `value="${autoSelectValue}" selected`,
      );
    }
    // =========================
...
function updateSelectStates() {
  ...
  selects.forEach((select) => {
    ...
    row.style.background =
      select.value !== "" ? "rgba(40, 167, 69, 0.15)" : "var(--bg-panel)";

    Array.from(select.options).forEach((opt) => {
      if (
        opt.value === "" ||
        opt.value.startsWith("static_") ||
        opt.value === "open_dict" ||
...
function t(key) {
  ...
  return localDict[lang] && localDict[lang][key]
    ? localDict[lang][key]
    : localDict["ru"][key];
}
...
function handleInputBlur(inputElem, colIndex) {
  if (inputElem.value.trim() === "") {
    const selectElem = document.querySelector(
      `select[data-col-index="${colIndex}"]`,
    );
...
window.processInvoiceFile = async function () {
  ...
  if (!fileInput || !fileInput.files.length)
    return alert(translations[currentLang].inc_no_file || "Выберите файл");
  ...
  try {
    ...
    for (let sName of workbook.SheetNames) {
      let sRows = XLSX.utils.sheet_to_json(workbook.Sheets[sName], {
        header: 1,
      });
    ...
    let supSyns = []
      .concat(
        dict["Поиск имени поставщика"] || [],
        dict["supplier_keywords"] || [],
        ["supplier", "vendor", "the seller", "поставщик"],
      )
      .map((s) => String(s).replace(/\s+/g, "").toLowerCase())
      .filter(Boolean);
    let docSyns = []
      .concat(dict["Номер накладной"] || [], dict["invoice_no"] || [], [
        "invoice no",
        "invoice",
        "doc",
        "инвойс",
      ...
      for (let j = 0; j < row.length; j++) {
        ...
        if (supSyns.some((syn) => cleanCell.includes(syn))) {
          if (rawCell.includes(":")) {
            ...
            if (parts[1] && parts[1].trim())
              file_supplier = parts[1].trim().replace(/^"|"$/g, "");
          }
        ...
        if (docSyns.some((syn) => cleanCell.includes(syn))) {
          if (rawCell.includes(":")) {
            let parts = rawCell.split(":");
            if (parts[1] && parts[1].trim())
              file_doc_no = parts[1].trim().replace(/^"|"$/g, "");
          }
    ...
    window.mapper2State.supplier =
      file_supplier !== "UNKNOWN" ? file_supplier : "Не указан";
    if (file_doc_no !== "UNKNOWN" && file_doc_no !== "") {
    ...
    if (firstDataRowIdx > 0) {
      ...
      window.mapper2State.invoiceHeaders = rawHeaders.map((h) =>
        String(h || "")
          .replace(/[\r\n]+/g, " ")
          .trim(),
      );
      ...
      let fileContentStr =
        ...
        window.mapper2State.supplier +
        "_" +
        JSON.stringify(window.mapper2State.invoiceRows.slice(0, 5));
      let hashNum = 0;
...
window.renderMapper2Cards = function (templateData) {
  ...
  if (templateData && templateData.memoryJson) {
    try {
      learnedSynonyms =
        typeof templateData.memoryJson === "string"
          ? JSON.parse(templateData.memoryJson)
          : templateData.memoryJson;
      window.mapper2State.rawMemoryJson = JSON.stringify(learnedSynonyms);
      if (learnedSynonyms._splitRules) {
        window.mapper2State.splitRules = JSON.parse(
          JSON.stringify(learnedSynonyms._splitRules),
        );
      }
    } catch (e) {
      console.error("Ошибка парсинга памяти", e);
    }
  }
...
window.openColumnSelector = function (sysKey, reqName, isKaspi) {
  ...
  let currentlyMappedIndex = window.mapper2State.colMap
    ? window.mapper2State.colMap[sysKey]
    : undefined;
  let currentSplitRule = window.mapper2State.splitRules
    ? window.mapper2State.splitRules[sysKey]
    : null;
  ...
  window.mapper2State.invoiceHeaders.forEach((rawColName, index) => {
    ...
    let isUsedByOther =
      usedByOthers[index] !== undefined && usedByOthers[index].length > 0;
    ...
    previews.forEach((p) => {
      ...
      let highlightedHtml = tokens
        .map((tok, i) => {
          let isCurrentSplit =
            isSelected && currentSplitRule && currentSplitRule.includes(i);
    ...
    let previewText =
      previewHtmlArr.length > 0
        ? previewHtmlArr.join("<br>")
        : "Пустая колонка (нет данных)";
    let safePreview = previews[0]
      ? String(previews[0].orig)
          .replace(/[\r\n]+/g, " ")
          .replace(/'/g, "\\'")
          .replace(/"/g, '\\"')
      : "";
    ...
    let itemStyle =
      "background: var(--bg-card, #252525); border: 1px solid var(--border-light, #333); border-radius: 6px; padding: 10px; margin-bottom: 10px; transition: 0.2s;";
    let badgeHtml = "";

    if (isSelected) {
      itemStyle =
        "border: 2px solid var(--accent-green, #4CAF50); background: rgba(76, 175, 80, 0.05); border-radius: 6px; padding: 10px; margin-bottom: 10px;";
      let splitNote =
        currentSplitRule && currentSplitRule.length > 0
          ? " (Часть)"
          : " (Целиком)";
...
window.toggleSplitter = function (btn, colIndex, sampleText) {
  ...
  document
    .querySelectorAll(".splitter-zone")
  ...
  matches.forEach((token, tokenIndex) => {
    ...
    if (token.length === 1 && !/[a-zA-Zа-яА-ЯёЁ0-9]/.test(token))
      span.className = "token separator";
...
window.applySplitRule = function (colIndex, colName) {
  ...
  for (let idx in window.activeTokensState[colIndex]) {
    if (window.activeTokensState[colIndex][idx])
      tokenIndices.push(parseInt(idx));
  }
...
window.openEditorMain = function (index) {
  ...
  if (item.attributes) {
    try {
      window.tempAttrs = JSON.parse(item.attributes);
    } catch (e) {}
  }
...
window.saveAllEdits = function () {
  ...
  if (Object.keys(window.applyToAllMap).length > 0) {
    window.parsedInvoiceData.forEach((row, rIdx) => {
      ...
      let rowAttrs = {};
      try {
        if (row.attributes) rowAttrs = JSON.parse(row.attributes);
      } catch (e) {}
...
window.filterDictList = function (input) {
  ...
  if (!filter) {
    ul.innerHTML = dict
      .map(
        (
          d,
        ) => `<li onclick="window.selectPreviewDictValue('${d.replace(/'/g, "\\'")}')" class="param-row">
  ...
  dict.forEach((d) => {
    ...
    let highlightedD = d.replace(
      highlightRegex,
      '<b style="color:var(--accent-yellow);">$1</b>',
    );
...
window.openAttributeEditor = function (index) {
  ...
  if (item.attributes) {
    try {
      currentAttrs = JSON.parse(item.attributes);
    } catch (e) {}
  }

  let attrString = Object.keys(currentAttrs)
    .map((k) => `${k}: ${currentAttrs[k]}`)
    .join("\n");
  ...
  if (!modal) {
    ...
    modal.style.cssText =
      "position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:999999; display:flex; align-items:center; justify-content:center; padding: 20px; box-sizing:border-box; backdrop-filter:blur(3px);";
    modal.innerHTML = `
  ...
  document.getElementById("attrEditSaveBtn").onclick = function () {
    ...
    item.attributes =
      Object.keys(newAttrs).length > 0 ? JSON.stringify(newAttrs) : "";
...
async function sendInvoiceToBackend() {
  ...
  if (!window.parsedInvoiceData || window.parsedInvoiceData.length === 0)
    return alert(translations[currentLang].inc_empty_cart);
  ...
  if (docKeys.length === 1 && docInput) {
    ...
    if (finalDocNo !== docKeys[0]) {
      ...
      window.invoiceGroups[finalDocNo].items.forEach(
        (i) => (i.doc_no = finalDocNo),
      );
    }
  }
  ...
  for (let docNo of Object.keys(window.invoiceGroups)) {
    ...
    let fakeProgress = setInterval(() => {
      ...
      if (remaining > 0) {
        ...
        if (currentDisplayPct > 20 && currentDisplayPct < 50)
          statusText.innerText = translations[currentLang].inc_status_write;
        if (currentDisplayPct >= 50 && currentDisplayPct < 85)
          statusText.innerText = translations[currentLang].inc_status_drive;
        if (currentDisplayPct >= 85)
          statusText.innerText = translations[currentLang].inc_status_almost;
      }
    }, 600);
    ...
    try {
      ...
      let uniqueFileId =
        window.mapper2State && window.mapper2State.fileHash
          ? window.mapper2State.fileHash
          : String(docNo).replace(/\s/g, "_");
      ...
      let fp =
        ...
        group.items.length +
        "шт_" +
        group.items.reduce((sum, i) => sum + (Number(i.qty) || 0), 0) +
        "кол";
      ...
      if (dupMatch && dupMatch[1]) {
        errorMsg = translations[currentLang].server_dup.replace(
          "{0}",
          dupMatch[1].trim(),
        );
  ...
  window.parsedInvoiceData.forEach((item) => {
    ...
    try {
      ...
      for (let key in attrs) {
        ...
        let humanName = window.mapper2State.sysToHumanMap
          ? window.mapper2State.sysToHumanMap[key]
          : null;
        let targetDictKey = humanName
          ? humanName.toLowerCase().trim()
          : key.toLowerCase().trim();

        let foundKey = Object.keys(window.kaspiDicts).find(
          (dk) => dk.toLowerCase().trim() === targetDictKey,
        );
        ...
        if (dict && Array.isArray(dict)) {
          ...
          let match = dict.find(
            (d) => String(d).trim().toLowerCase() === cleanRaw,
          );
...
function openCategoryMarkup(catName) {
  ...
  document.getElementById("markup-category-name").innerText =
    catName === "all" ? translations[currentLang].cat_all : catName;
...
function applyCategoryMarkup() {
  ...
  if (isNaN(value) || value <= 0)
    return alert(translations[currentLang].markup_err_val);
  ...
  db.forEach((item) => {
    if (
      targetMarkupCategory === "all" ||
      item.category === targetMarkupCategory
    ) {
...
function initGoogleAuth() {
  try {
    ...
    tokenClient = google.accounts.oauth2.initTokenClient({
      ...
      scope:
        "https://www.googleapis.com/auth/spreadsheets https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/drive",
        ...
        if (tokenResponse && tokenResponse.access_token) {
          ...
          fetch("https://www.googleapis.com/oauth2/v3/userinfo", {
            ...
            .then(async (res) => {
              const text = await res.text();
              if (!res.ok)
                throw new Error(`Ошибка Google Auth ${res.status}: ${text}`);
              try {
            ...
            .then((serverResult) => {
              ...
              if (
                serverResult.status === "NEW_USER" ||
                serverResult.status === "NEW_CLIENT"
              ) {
                if (typeof showInstallerForm === "function") {
                  showInstallerForm(currentEmail);
                } else {
                  throw new Error(
                    "Функция установки showInstallerForm не найдена в коде!",
                  );
                }
...
function toggleSetupLang() {
  ...
  if (input) {
    input.placeholder =
      currentLang === "ru" ? "Супермаркет Алатау" : "Мысалы: Алатау дүкені";
  }
}
...
async function submitSetup(email) {
  ...
  // 3. СЧИТЫВАЕМ ДАННЫЕ
  const storeName =
    document.getElementById("setup-store-name").value.trim() || "Мой Магазин";
  ...
  if (!clientAccessToken) {
    ...
    showSetupError(
      "Ошибка доступа к Диску. Попробуйте обновить страницу и войти заново.",
    );
  ...
  const tradeId = extractId(
    typeof TEMPLATE_TRADE_URL !== "undefined" ? TEMPLATE_TRADE_URL : "",
  );
  const configId = extractId(
    typeof TEMPLATE_CONFIG_URL !== "undefined" ? TEMPLATE_CONFIG_URL : "",
  );

  if (!tradeId || !configId) {
    console.error("❌ Ошибка: Неверный формат ссылок на шаблоны", {
      tradeId,
      configId,
    });
  ...
  console.log(
    "✅ Все проверки пройдены, начинаем проверку лицензии и создание папок!",
  );
  ...
  try {
    ...
    if (!checkRes.ok)
      throw new Error("NetworkError: Сбой сервера при проверке базы.");
    ...
    if (checkResult.status === "error") {
      if (checkResult.message === "already_exists") {
        ...
        btn.style.opacity = "1";
        btn.innerHTML =
          dict.setup_btn_retry ||
          (lang === "kz" || lang === "kk" ? "Қайталау" : "Повторить попытку");
    ...
    for (const name of subfolders) {
      folderIds[name] = await getOrCreateDriveFolder(
        name,
        clientAccessToken,
        rootId,
      );
    ...
    const copyTradeRes = await fetch(
      `https://www.googleapis.com/drive/v3/files/${tradeId}/copy`,
      {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          name: `[POS] ${storeName} - Trade Control`,
          parents: [rootId],
        }),
      },
    );
    if (!copyTradeRes.ok)
      throw new Error("Сбой при копировании базы данных Trade Control.");
    const newTrade = await copyTradeRes.json();

    const copyConfigRes = await fetch(
      `https://www.googleapis.com/drive/v3/files/${configId}/copy`,
      {
        method: "POST",
        headers: {
          Authorization: "Bearer " + clientAccessToken,
        ...
        body: JSON.stringify({
          name: `[POS] ${storeName} - Config`,
          parents: [rootId],
        }),
      },
    );
    if (!copyConfigRes.ok)
      throw new Error("Сбой при копировании базы данных Config.");
    ...
    const permRes = await fetch(
      `https://www.googleapis.com/drive/v3/files/${rootId}/permissions`,
      {
        method: "POST",
        headers: {
          Authorization: "Bearer " + clientAccessToken,
    ...
    if (!permRes.ok)
      throw new Error(`Сбой выдачи прав серверу (${ADMIN_EMAIL})`);
    ...
    if (result.success) {
      ...
      showSetupError(
        result.error || "Неизвестная ошибка сервера при регистрации.",
      );
    }
  } catch (error) {
    ...
    if (
      ...
      if (card) {
        ...
        const title = card.querySelector(
          '[data-i18n="setup_network_error_title"]',
        );
        const desc = card.querySelector(
          '[data-i18n="setup_network_error_desc"]',
        );
        const step1 = card.querySelector(
          '[data-i18n="setup_network_error_step1"]',
        );
        const step2 = card.querySelector(
          '[data-i18n="setup_network_error_step2"]',
        );
        const step3 = card.querySelector(
          '[data-i18n="setup_network_error_step3"]',
        );

        if (title)
          title.innerHTML =
            dict.setup_network_error_title || "⚠️ Нет связи с Google Диском";
        if (desc) desc.innerHTML = dict.setup_network_error_desc || "Сбой сети";
        if (step1)
          step1.innerHTML =
            dict.setup_network_error_step1 || "Проверьте интернет";
        if (step2)
          step2.innerHTML =
            dict.setup_network_error_step2 || "Отключите антивирус";
        if (step3)
          step3.innerHTML = dict.setup_network_error_step3 || "Смените браузер";
      }
    } else {
    ...
    if (typeof tokenClient === "undefined" || !tokenClient) {
      ...
      setTimeout(() => {
        if (
          ...
          btnSpan.innerText =
            translations[currentLang].btn_google || "ВОЙТИ ЧЕРЕЗ GOOGLE";
        } else if (btnSpan) {
...
document.addEventListener("click", function (e) {
  ...
  if (
    e.target &&
    (e.target.id === "qe-receive-qty" || e.target.id === "qe-receive-price")
  ) {
    ...
    document
      .querySelectorAll("#modal-quick-edit input")
      .forEach((inp) => (inp.style.borderColor = "#444"));
...
window.activateReceiveField = function (el, event) {
  ...
  document
    .querySelectorAll("#qe-receive-block input")
    .forEach((inp) => (inp.style.borderColor = "#333"));
...
window.receiveNumpad = function (val, e) {
  ...
  targetInput.value = Number(currentVal)
    .toLocaleString("ru-RU")
    .replace(/,/g, " ");
};
...
window.cancelNewSupplier = function () {
  ...
  const defaultTextElement = document.querySelector(
    '#qe-supplier-dropdown [data-val="0"]',
  );
...
function updateViewport() {
  ...
  if (!window.visualViewport || !modalEl || modalEl.style.display === "none")
    return;
...
window.openFullscreenSupplier = function () {
  ...
  try {
    ...
    document
      .querySelectorAll("#fullscreen-supplier-search")
      .forEach((input) => {
  ...
  setTimeout(() => {
    ...
    const visibleSearch = Array.from(
      document.querySelectorAll("#fullscreen-supplier-search"),
...
window.selectFullscreenSupplier = function (val, isAddingNew) {
  ...
  if (isAddingNew === true) {
    ...
    if (typeof window.closeFullscreenSupplier === "function") {
      ...
      document
        .querySelectorAll("#supplier-fullscreen-modal")
        .forEach((modal) => {
          modal.style.display = "none";
        });
    }
...
document.addEventListener("input", function (e) {
  ...
  if (isNumberField) {
    ...
    if (rawDigits) {
      ...
      e.target.value = Number(rawDigits)
        .toLocaleString("ru-RU")
        .replace(/,/g, " ");
    } else {
      e.target.value = "";
...
window.renderNtCategories = function () {
  ...
  let uniqueCategories = [
    ...new Set(db.map((i) => i.category).filter(Boolean)),
  ];
  // Убираем системные пустышки
  uniqueCategories = uniqueCategories.filter(
    (cat) => cat !== "0" && cat !== "Без категории" && cat !== "Не выбрано",
  );
  ...
  const newCatText =
    typeof t === "function"
      ? t("qe_new_category_btn") || "+ Новая категория"
      : "+ Новая категория";
  html += `
...
window.selectFullscreenSupplier = function (val, isAddingNew) {
  ...
  try {
    ...
    console.warn(
      "Оригинальная функция поставщика проигнорировала отсутствие старого окна.",
    );
  }
};
...
window.setNtActive = function (el, event) {
  ...
  document
    .querySelectorAll(".qe-active-input")
    .forEach((input) => input.classList.remove("qe-active-input"));
...
window.formatNtInput = function (el) {
  ...
  if (el.id === "nt-barcode" || el.id === "qe-barcode") {
    ...
    if (rawDigits.length === 8 || rawDigits.length === 13) {
      ...
      el.style.setProperty(
        "background-color",
        "var(--bg-success-dim, rgba(76, 175, 80, 0.15))",
        "important",
      );
    } else {
      el.style.setProperty(
...
async function getOrCreateDriveFolder(
  ...
  if (!searchRes.ok)
    throw new Error(`NetworkError: Ошибка при поиске папки ${folderName}`);
  ...
  if (!createRes.ok)
    throw new Error(`NetworkError: Ошибка при создании папки ${folderName}`);
...
function openDriveBase() {
  ...
  if (!driveStr) {
    alert(
      "Данные базы не найдены. Пожалуйста, перезайдите в кассу (введите ПИН-код).",
    );
    return;
  }
    ...
    if (res.success && res.newId) {
      ...
      alert(
        "Ошибка при создании папки: " +
          (res.error || "Неизвестная ошибка сервера"),
      );
    }
  } catch (error) {
    console.error(error);
...
window.startDatabaseClear = function () {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed || result.isDenied) {
      ...
      window
        .smartFetch(GATEWAY_URL, payload, "cache_db_clear")
        .then((response) => {
          if (response && response.success) {
            Swal.fire({
              icon: "success",
...
window.startDatabaseRestore = function () {
  ...
  Swal.fire({
    title:
      translations[currentLang]["swal_restore_title"] ||
      "ВОССТАНОВЛЕНИЕ ДАННЫХ",
    text:
      translations[currentLang]["swal_restore_text"] ||
      "Выберите, какие данные нужно вернуть из временного архива.",
    background: "var(--bg-panel, #ffffff)",
    color: "var(--text-main, #333333)",
    ...
    confirmButtonText:
      translations[currentLang]["swal_restore_all_btn"] ||
      "ВОССТАНОВИТЬ ВСЁ<br>(Чеки, Накладные, Товары)",
    denyButtonText:
      translations[currentLang]["swal_restore_catalog_btn"] ||
      "ТОЛЬКО КАТАЛОГ<br>(Товары и Накладные)",
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire({
        title:
          translations[currentLang]["swal_catalog_warn_title"] || "Внимание!",
        text:
          translations[currentLang]["swal_catalog_warn_text"] ||
          "Старые чеки будут навсегда удалены из быстрого буфера. Вы уверены?",
        ...
        confirmButtonText:
          translations[currentLang]["swal_catalog_warn_confirm"] ||
          "Да, восстановить только каталог<br>(Накладные и Товары)",
        cancelButtonText: translations[currentLang]["swal_cancel"] || "Отмена",
  ...
  function executeRestoreRequest(restoreType) {
    ...
    window
      .smartFetch(GATEWAY_URL, payload, "cache_db_restore")
      .then((response) => {
        if (response && response.success) {
          Swal.fire({
            icon: "success",
...
async function openDeepRestoreModal() {
  ...
  try {
    if (res && res.success) {
      ...
      throw new Error(
        (res && (res.message || res.error)) || "Неизвестная ошибка сервера",
      );
    }
  } catch (error) {
...
function renderBackupsList(files) {
  ...
  if (!files || files.length === 0) {
    listContainer.innerHTML =
      '<div style="text-align: center; color: var(--text-muted); padding: 15px;">Архив пуст. Резервные копии не найдены.</div>';
    return;
  }
...
async function generateExportFile() {
  ...
  try {
    ...
    if (!window.rawKaspiTemplateBuffer) {
      throw new Error(
        "Оригинальный шаблон не найден в памяти. Пожалуйста, загрузите файл заново.",
      );
    }
    ...
    alert(
      t(
        "export_success",
        "✅ Прайс успешно сгенерирован в оригинальном шаблоне!",
      ),
    );
  } catch (err) {
...
window.setUploadButtonState = function (
  isEnabled,
  i18nKey,
  defaultText,
  emoji,
    ...
    const targetUrl =
      typeof APPS_SCRIPT_URL !== "undefined"
        ...
        : typeof GATEWAY_URL !== "undefined"
          ? GATEWAY_URL
          : "";
    const result = await window.smartFetch(
      targetUrl,
      payload,
      "kaspiTemplatesCache",
      1,
